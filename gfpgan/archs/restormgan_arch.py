...
from gfpgan.archs.restormer_arch import (OverlapPatchEmbed, TransformerBlock, Downsample, Upsample)
import numpy as np
...
class RESTORMGAN(nn.Module):
    def __init__(
        ...
        super(RESTORMGAN, self).__init__()
        self.input_is_latent = input_is_latent
        self.different_w = different_w
        self.num_style_feat = num_style_feat
        self.style_code = np.load('D:/FSR_Code/GFPGAN-master/experiments/pretrained_models/mean_latents.npy')
