...
class RESTORMGANCNNModel(BaseModel2):
    ...
    def optimize_parameters(self, current_iter):
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            if pyramid_loss_weight > 0:
                l_pyramid = self.cri_l1(out_rgbs[6], pyramid_gt[6]) * pyramid_loss_weight
                l_g_total += l_pyramid
                loss_dict[f'l_p_{2 ** 9}'] = l_pyramid
